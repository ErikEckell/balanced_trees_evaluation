#include "/home/edauandes/eda_cpp/trees_tarea3/avl/include/trees/avl.hpp"
#include <iostream>
#include <string>
#include <fstream>
#include <iostream>
...
int main(int nargs, char** vargs){
    int n_data = 0;
	int n_queries = 0;
    int* data = readKeysFromFile("/home/edauandes/eda_cpp/data_trees/keys_32768.bin", &n_data);
	...
	std::cout << "Tiempo de ejecución: " << duracion << " nanosegundos" << std::endl;

	auto inicio2 = std::chrono::high_resolution_clock::now();
    for(int i=0; i<1000;i++){
        avltree.find(queries[i]);
    } 
	...
	std::cout << "Tiempo de ejecución: " << duracion2 << " nanosegundos" << std::endl;
